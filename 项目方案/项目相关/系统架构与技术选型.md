...
| 层级 | 技术 | 版本 | 选型理由 |
|------|------|:--:|------|
| 后端框架 | Spring Boot | 3.5.x | 内嵌 Tomcat，约定优于配置，IDEA 最新版完全支持 |
...
| 构建 | Maven | 3.6.3+ | Spring Boot 3.x 最低要求 |
| JDK | OpenJDK | 17 | Spring Boot 3.x 最低要求 LTS，生态兼容性广 |
| IDE | IntelliJ IDEA | Community | 免费，Spring Boot 3.x 支持好 |
