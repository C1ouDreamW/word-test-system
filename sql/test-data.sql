...
-- 3. 考试数据（显式 ID，4 场考试）
-- =============================================
INSERT INTO exams (id, title, start_time, end_time, question_count) VALUES
(1, '四级基础词汇测试',    '2026-05-10 09:00:00', '2026-05-10 11:00:00', 20),
(2, '四级综合测试',        '2026-05-20 14:00:00', '2026-05-20 16:00:00', 15),
(3, '六级词汇测试',        '2026-06-23 08:00:00', '2026-06-24 08:00:00', 30),
(4, '四六级综合补考',      '2026-07-01 10:00:00', '2026-07-01 12:00:00', 20);

-- =============================================
-- 4. 题目数据（显式 ID，共 170 题）
-- =============================================
...
-- =============================================
-- 5. 答案数据（显式 ID，模拟学生的答题记录，共 170 条）
-- =============================================
...
--                 49-60 六级学术词汇）
-- 考试：4 场（id: 1-4）
-- 题目：170 题（id: 1-170，EN_TO_CN / CN_TO_EN / CHOICE）
-- 答案：170 条（id: 1-170，含少量错误答案用于测试评分统计）
-- =============================================
